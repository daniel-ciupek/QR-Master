export default {
    ...
    qr: {
        ...
        tabs: {
            ...
            review: 'Review',
            desc: {
                url: 'Link to a website, product or marketing campaign',
                text: 'Any text, quote or message',
                email: 'Opens email client with pre-filled address and subject',
                phone: 'Dials a phone number with one tap',
                sms: 'Pre-filled SMS message ready to send',
                vcard: 'Digital business card saved to contacts',
                wifi: 'Connects to WiFi without typing the password',
                geo: 'GPS navigation to a specific location on the map',
                pdf: 'Restaurant menu, product catalog or document',
                bio_link: 'Landing page with multiple links, like Linktree',
                app: 'Link to your app on App Store and Google Play',
                calendar: 'Event added to calendar with one tap',
                crypto: 'Cryptocurrency wallet address for payments',
                review: 'Direct link to leave a review on Google or Yelp',
            },
        },
        fields: {
    ...
    webhooks: {
        pageTitle: 'Webhooks — QR-Master',
        title: 'Outbound webhooks',
        subtitle: 'Receive a POST request on your endpoint every time a QR code is scanned.',
        noWebhooks: 'No webhooks configured yet.',
        addBtn: 'Add webhook',
        urlLabel: 'Endpoint URL',
        urlPlaceholder: 'https://your-server.com/webhook',
        eventsLabel: 'Events',
        eventQrScanned: 'qr.scanned — QR code scanned',
        createBtn: 'Create webhook',
        deleteConfirm: 'Are you sure you want to delete this webhook? This action is irreversible.',
        secretLabel: 'Signing secret',
        secretHint: 'Use this secret to verify the X-QR-Master-Signature header (HMAC-SHA256).',
        colUrl: 'URL',
        colEvents: 'Events',
        colStatus: 'Status',
        ...
        active: 'Active',
        inactive: 'Inactive',
        viewDeliveries: 'Delivery log',
        deliveriesTitle: 'Delivery log',
        deliveriesSubtitle: 'History of webhook delivery attempts.',
        colEvent: 'Event',
        ...
        signatureNote: 'Verify signature: compute HMAC-SHA256 of the raw request body using your secret and compare to X-QR-Master-Signature header.',
    },
    ...
    csvImport: {
        ...
        subtitle: 'Upload a CSV file to bulk-create QR codes.',
        stepUpload: 'Upload',
        stepMapping: 'Column mapping',
        stepProgress: 'Importing',
        stepDone: 'Done',
        dropzone: 'Drop CSV file here or click to browse',
        dropzoneHint: 'Max 10 MB. First row must be a header row.',
        browseFile: 'Browse file',
        uploadBtn: 'Upload and preview',
        totalRows: 'rows found',
        headerRow: 'Header row',
        previewRows: 'Data preview',
        mappingTitle: 'Map CSV columns to QR code fields',
        mappingHint: 'Select which CSV column corresponds to each QR code field.',
        fieldTitle: 'Title (required)',
        fieldDestUrl: 'Destination URL',
        fieldType: 'QR type column',
        fieldIsActive: 'Is active',
        fieldExpiresAt: 'Expires at',
        fieldScanLimit: 'Scan limit',
        defaultType: 'Default QR type (when no type column)',
        noColumn: '— none —',
        startImport: 'Start import',
        importing: 'Importing…',
        progressLabel: 'rows imported',
        failedLabel: 'rows failed',
        cancelImport: 'Cancel',
        doneTitle: 'Import complete',
        doneSubtitle: 'Your QR codes have been created.',
        goToList: 'Go to QR codes',
        importAnother: 'Import another file',
        errorUpload: 'Failed to upload CSV. Please try again.',
        errorProcess: 'Failed to start import. Please try again.',
        finishedWithErrors: 'Import finished with some errors.',
