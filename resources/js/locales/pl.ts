export default {
    ...
    qr: {
        ...
        edit: {
            ...
            fields: {
                ...
                customSlug: {
                    ...
                    placeholder: 'moja-promocja',
                    hint: 'Tylko litery, cyfry, myślniki i podkreślenia. Dostępny pod /s/twoj-slug.',
                },
                geo: {
        ...
        tabs: {
            ...
            review: 'Recenzja',
            desc: {
                url: 'Link do strony, produktu lub kampanii marketingowej',
                text: 'Dowolny tekst, cytat lub wiadomość',
                email: 'Otwiera klienta e-mail z wypełnionym adresem i tematem',
                phone: 'Wybiera numer telefonu jednym kliknięciem',
                sms: 'Gotowa wiadomość SMS do wysłania',
                vcard: 'Wizytówka — zapisuje dane kontaktowe w telefonie',
                wifi: 'Loguje do sieci WiFi bez wpisywania hasła',
                geo: 'Nawigacja GPS do konkretnego miejsca na mapie',
                pdf: 'Menu restauracji, katalog produktów lub dokument',
                bio_link: 'Strona z wieloma linkami, jak Linktree',
                app: 'Link do aplikacji w App Store i Google Play',
                calendar: 'Wydarzenie dodawane do kalendarza jednym tapnięciem',
                crypto: 'Adres portfela kryptowalutowego do płatności',
                review: 'Bezpośredni link do wystawienia opinii w Google lub Yelp',
            },
        },
        fields: {
    ...
    bioLink: {
        ...
        ai: {
            professionPlaceholder: 'np. fotograf freelancer, właściciel restauracji…',
            generate: 'Generuj',
            linkSuggestions: 'Sugerowane tytuły linków:',
        },
        items: {
    ...
    webhooks: {
        pageTitle: 'Webhooki — QR-Master',
        title: 'Webhooki wychodzące',
        subtitle: 'Otrzymuj żądanie POST na swój endpoint przy każdym skanowaniu kodu QR.',
        noWebhooks: 'Brak skonfigurowanych webhooków.',
        addBtn: 'Dodaj webhook',
        urlLabel: 'URL endpointu',
        urlPlaceholder: 'https://twoj-serwer.pl/webhook',
        eventsLabel: 'Zdarzenia',
        eventQrScanned: 'qr.scanned — skan kodu QR',
        createBtn: 'Utwórz webhook',
        deleteConfirm: 'Czy na pewno chcesz usunąć ten webhook? Tej operacji nie można cofnąć.',
        secretLabel: 'Klucz podpisujący',
        secretHint: 'Użyj tego klucza do weryfikacji nagłówka X-QR-Master-Signature (HMAC-SHA256).',
        colUrl: 'URL',
        colEvents: 'Zdarzenia',
        colStatus: 'Status',
        colDeliveries: 'Dostarczenia',
        colCreated: 'Utworzono',
        active: 'Aktywny',
        inactive: 'Nieaktywny',
        viewDeliveries: 'Log dostarczone',
        deliveriesTitle: 'Log dostarczeń',
        deliveriesSubtitle: 'Historia prób dostarczenia webhooka.',
        colEvent: 'Zdarzenie',
        colAttempts: 'Próby',
        colHttpStatus: 'HTTP',
        colSentAt: 'Wysłano',
        ...
        noDeliveries: 'Brak prób dostarczenia.',
        signatureNote: 'Weryfikacja podpisu: oblicz HMAC-SHA256 z surowego ciała żądania kluczem tajnym i porównaj z nagłówkiem X-QR-Master-Signature.',
    },
    ...
    csvImport: {
        ...
        subtitle: 'Wgraj plik CSV, aby hurtowo tworzyć kody QR.',
        stepUpload: 'Wgrywanie',
        stepMapping: 'Mapowanie kolumn',
        stepProgress: 'Importowanie',
        stepDone: 'Gotowe',
        dropzone: 'Upuść plik CSV tutaj lub kliknij, aby wybrać',
        dropzoneHint: 'Maks. 10 MB. Pierwszy wiersz musi być nagłówkiem.',
        browseFile: 'Wybierz plik',
        uploadBtn: 'Wgraj i podejrzyj',
        totalRows: 'wierszy danych',
        headerRow: 'Wiersz nagłówka',
        previewRows: 'Podgląd danych',
        mappingTitle: 'Przypisz kolumny CSV do pól kodu QR',
        mappingHint: 'Wybierz, która kolumna CSV odpowiada danemu polu kodu QR.',
        fieldTitle: 'Tytuł (wymagany)',
        fieldDestUrl: 'Docelowy URL',
        fieldType: 'Kolumna typu QR',
        fieldIsActive: 'Aktywny',
        fieldExpiresAt: 'Wygasa',
        fieldScanLimit: 'Limit skanów',
        defaultType: 'Domyślny typ QR (gdy brak kolumny typu)',
        noColumn: '— brak —',
        startImport: 'Rozpocznij import',
        importing: 'Importowanie…',
        progressLabel: 'wierszy zaimportowanych',
        failedLabel: 'wierszy nieudanych',
        cancelImport: 'Anuluj',
        doneTitle: 'Import zakończony',
        doneSubtitle: 'Twoje kody QR zostały utworzone.',
        goToList: 'Przejdź do listy QR',
        importAnother: 'Importuj kolejny plik',
        errorUpload: 'Błąd wgrywania CSV. Spróbuj ponownie.',
        errorProcess: 'Nie udało się rozpocząć importu. Spróbuj ponownie.',
        finishedWithErrors: 'Import zakończony z błędami.',
        finished: 'Import zakończony pomyślnie.',
    },
    ...
    offline: {
        ...
        pendingDrafts: '{n} szkic zapisany offline | {n} szkice zapisane offline',
        syncNow: 'Synchronizuj teraz',
        untitledDraft: 'Nienazwany szkic',
    },
