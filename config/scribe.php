...
return [
    ...
    'description' => 'REST API for programmatic access to QR codes, analytics, and folders. Requires a Business or Enterprise plan. All endpoints use Bearer token authentication (Sanctum).',
